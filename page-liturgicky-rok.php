    ...
    <main id="main" class="site-main" role="main">
        ...
        if (empty($all_sundays) || empty($all_stories_data)) {
            ...
            foreach ($upcoming_sundays as $sunday) {
                ...
                // Najdeme ID příběhu a zároveň určíme, který sloupec je vyplněný
                $story_id = '';
                $evangelist_key = '';
                ...
                $button_text = 'Příběh se připravuje'; // Výchozí text

                // Pokud příběh existuje, najdeme jeho název a citaci
                if ($has_story && isset($all_stories_data[$story_id])) {
                    ...
                    // Sestavíme finální text tlačítka
